...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        print("qk_rotary_emb: ", end - start, end=" ")
...
class LlamaDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        print("input_layernorm: ",end - start, end=" ")
        ...
        print("post_attention_layernorm: ",end - start, end=" ")
