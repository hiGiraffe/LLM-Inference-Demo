...
model = AutoModelForCausalLM.from_pretrained(
    "/home/cjl/llama/llama-2-7b-hf", low_cpu_mem_usage=True, attn_implementation="sdpa"
)
model.eval()

# Input configs
# Create example inputs for the model
tokenizer = AutoTokenizer.from_pretrained("/home/cjl/llama/llama-2-7b-hf")

# prompts = ("I would like to", "I really like to", "Life","Today")  # bs = 3
prompts = ("Create a pipeline stage", "I really like to", "The weather is a")  # bs = 3
...
# if PartialState().is_last_process:
#     print("inputs = ",inputs)
#     print("ouputs= ",output[0])


print(model.hf_split_points)
